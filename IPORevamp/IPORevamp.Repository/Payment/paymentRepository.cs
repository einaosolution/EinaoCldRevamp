...
namespace IPORevamp.Repository.Payment
{
    class paymentRepository : IpaymentRepository
    {
        ...
        public paymentRepository(IRepository<IPORevamp.Data.Entity.Interface.Entities.Payment.Payment> payment, IRepository<IPORevamp.Data.Entity.Interface.Entities.Twallet.Twallet> twallet, IRepository<IPORevamp.Data.Entity.Interface.Entities.FeeDetail.FeeDetail> feedetail)
        {
            _payment = payment;
            _twallet = twallet;
