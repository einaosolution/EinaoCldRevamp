...
{
    public class Billing<TBill, TPayment, TUser, TUserKey> : IBilling<TBill, TPayment, TUser, TUserKey> where TBill:Bill<TUser,TUserKey,TPayment> where TPayment: PaymentLog<TUser, TUserKey> where TUser:IdentityUser<TUserKey> where TUserKey: IEquatable<TUserKey>
    {
