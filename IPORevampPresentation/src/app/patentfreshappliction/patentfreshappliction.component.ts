...
@Component({
  selector: 'app-patentfreshappliction',
  templateUrl: './patentfreshappliction.component.html',
  styleUrls: ['./patentfreshappliction.component.css']
})
export class PatentfreshapplictionComponent implements OnInit {
...
this. getallApplication2()
  ...
  getallApplication2() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetPatentFreshapplication(userid)
    .then((response: any) => {
