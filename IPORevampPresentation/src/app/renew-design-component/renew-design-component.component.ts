...
@Component({
  selector: 'app-renew-design-component',
  templateUrl: './renew-design-component.component.html',
  styleUrls: ['./renew-design-component.component.css']
})
export class RenewDesignComponentComponent implements OnInit {
...
let userid = localStorage.getItem('UserId');
   ...
   this.busy =   this.registerapi
    .GetDesignApplicationByIdCount(this.regnumber)
    .then((response: any) => {
   ...
   this.busy =   this.registerapi
    .GetDesignApplicationById3(userid ,this.regnumber)
    .then((response: any) => {
...
if (kk.trademarktype =="Non-Textile Design"  ) {
  localStorage.setItem('designtype' ,"NONTextile")
}

else {
  localStorage.setItem('designtype' ,"Textile")
}
