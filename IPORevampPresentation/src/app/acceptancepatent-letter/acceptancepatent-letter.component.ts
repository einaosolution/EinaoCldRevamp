...
@Component({
  selector: 'app-acceptancepatent-letter',
  templateUrl: './acceptancepatent-letter.component.html',
  styleUrls: ['./acceptancepatent-letter.component.css']
})
export class AcceptancepatentLetterComponent implements OnInit {
