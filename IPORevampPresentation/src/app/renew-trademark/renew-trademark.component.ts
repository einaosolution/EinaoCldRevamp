...
@Component({
  selector: 'app-renew-trademark',
  templateUrl: './renew-trademark.component.html',
  styleUrls: ['./renew-trademark.component.css']
})
export class RenewTrademarkComponent implements OnInit {
