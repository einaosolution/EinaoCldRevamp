...
@Component({
  selector: 'app-gen-recordal-renew-patent2-component',
  templateUrl: './gen-recordal-renew-patent2-component.component.html',
  styleUrls: ['./gen-recordal-renew-patent2-component.component.css']
})
export class GenRecordalRenewPatent2ComponentComponent implements OnInit {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalRenewalPatentCertificate2(userid)
    .then((response: any) => {
 ...
 this.pwalletid2= kk.renewalid
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/TreatedRenewal"))  {
