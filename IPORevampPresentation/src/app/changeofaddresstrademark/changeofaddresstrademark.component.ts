...
@Component({
  selector: 'app-changeofaddresstrademark',
  templateUrl: './changeofaddresstrademark.component.html',
  styleUrls: ['./changeofaddresstrademark.component.css']
})
export class ChangeofaddresstrademarkComponent implements OnInit {
...
if (this.regnumber == "") {
  Swal.fire(
   ...
   this.busy =   this.registerapi
    .GetByRegistrationId(userid ,this.regnumber)
    .then((response: any) => {
  ...
  this.router.navigateByUrl('/Dashboard/Noticeofchangeofaddress');
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/ChangeOfAddress"))  {
