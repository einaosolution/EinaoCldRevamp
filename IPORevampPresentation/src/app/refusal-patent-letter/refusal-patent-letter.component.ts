...
@Component({
  selector: 'app-refusal-patent-letter',
  templateUrl: './refusal-patent-letter.component.html',
  styleUrls: ['./refusal-patent-letter.component.css']
})
export class RefusalPatentLetterComponent implements OnInit {
