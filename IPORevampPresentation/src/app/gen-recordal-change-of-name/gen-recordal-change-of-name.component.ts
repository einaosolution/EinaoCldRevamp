...
@Component({
  selector: 'app-gen-recordal-change-of-name',
  templateUrl: './gen-recordal-change-of-name.component.html',
  styleUrls: ['./gen-recordal-change-of-name.component.css']
})
export class GenRecordalChangeOfNameComponent implements OnInit {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalChangeOfName(userid,Status.Paid)
    .then((response: any) => {
