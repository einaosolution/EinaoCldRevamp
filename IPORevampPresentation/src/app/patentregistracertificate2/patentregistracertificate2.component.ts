...
@Component({
  selector: 'app-patentregistracertificate2',
  templateUrl: './patentregistracertificate2.component.html',
  styleUrls: ['./patentregistracertificate2.component.css']
})
export class Patentregistracertificate2Component implements OnInit {
...
onChange( deviceValue) {
  ...
  onSubmit2(f) {
   ...
   if (this.appdescription =="Examiner") {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/PatentCertificateExaminePayment"))  {
