...
@Component({
  selector: 'app-patent-user-application',
  templateUrl: './patent-user-application.component.html',
  styleUrls: ['./patent-user-application.component.css']
})
export class PatentUserApplicationComponent implements OnInit {
...
localStorage.setItem('Pwallet',this.pwalletid );
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/PatentUserApplication"))  {
