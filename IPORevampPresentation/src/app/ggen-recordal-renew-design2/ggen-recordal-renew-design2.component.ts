...
@Component({
  selector: 'app-ggen-recordal-renew-design2',
  templateUrl: './ggen-recordal-renew-design2.component.html',
  styleUrls: ['./ggen-recordal-renew-design2.component.css']
})
export class GgenRecordalRenewDesign2Component implements OnInit {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalRenewalDesignCertificate2(userid)
    .then((response: any) => {
 ...
 this.pwalletid = kk.pwalletid
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Design/TreatedRenewal"))  {
