...
@Component({
  selector: 'app-design-appeal',
  templateUrl: './design-appeal.component.html',
  styleUrls: ['./design-appeal.component.css']
})
export class DesignAppealComponent implements OnInit {
...
onSubmit2() {
  ...
  this.registerapi
.SendRegistraAppealReply(userid,this.pwalletid)
.then((response: any) => {
