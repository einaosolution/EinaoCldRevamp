...
@Component({
  selector: 'app-generate-issued-certificate',
  templateUrl: './generate-issued-certificate.component.html',
  styleUrls: ['./generate-issued-certificate.component.css']
})
export class GenerateIssuedCertificateComponent implements OnInit {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/GenerateCertificate"))  {
    ...
    this.registerapi.setPage("TrademarkCertificate")

    this.registerapi.VChangeEvent("TrademarkCertificate");
