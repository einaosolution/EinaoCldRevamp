...
@Component({
  selector: 'app-patent-appeal-unit',
  templateUrl: './patent-appeal-unit.component.html',
  styleUrls: ['./patent-appeal-unit.component.css']
})
export class PatentAppealUnitComponent implements OnInit {
...
onSubmit2() {
  ...
  if (this.appcomment =="") {
   ...
   formData.append("fromstatus",Status.Appeal);
   formData.append("tostatus",Status.ReceiveAppeal);
