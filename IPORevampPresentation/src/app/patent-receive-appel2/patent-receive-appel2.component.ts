...
@Component({
  selector: 'app-patent-receive-appel2',
  templateUrl: './patent-receive-appel2.component.html',
  styleUrls: ['./patent-receive-appel2.component.css']
})
export class PatentReceiveAppel2Component implements OnInit {
