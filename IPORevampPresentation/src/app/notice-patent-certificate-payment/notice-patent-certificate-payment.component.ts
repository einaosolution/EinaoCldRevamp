...
@Component({
  selector: 'app-notice-patent-certificate-payment',
  templateUrl: './notice-patent-certificate-payment.component.html',
  styleUrls: ['./notice-patent-certificate-payment.component.css']
})
export class NoticePatentCertificatePaymentComponent implements OnInit {
...
//$(this).steps("next");
  ...
  localStorage.setItem('PaymentType',"CertPatentPayment");
  ...
  this.busy =   this.registerapi
.GetFeeListByName("(A)CTC OF PATENT CERTIFICATE" ,userid)
.then((response: any) => {
