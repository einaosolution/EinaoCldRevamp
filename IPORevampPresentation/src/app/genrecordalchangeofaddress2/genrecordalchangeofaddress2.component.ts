...
@Component({
  selector: 'app-genrecordalchangeofaddress2',
  templateUrl: './genrecordalchangeofaddress2.component.html',
  styleUrls: ['./genrecordalchangeofaddress2.component.css']
})
export class Genrecordalchangeofaddress2Component implements OnInit {
@ViewChild('dataTable') table;
  ...
  this.busy =   this.registerapi.UpdateChangeOfAddressStatus(this.pwalletid2,userid,Status.Approved)
.then((response: any) => {
...
//this.router.navigateByUrl("/Dashboard/Certificate")
var userid = localStorage.getItem('UserId');
this.busy =   this.registerapi.UpdateChangeOfNameStatus(this.pwalletid2,userid,Status.Rejected)
.then((response: any) => {
...
onSubmit30() {
  $("#createmodel").modal('hide');
  this.router.navigateByUrl("/Dashboard/Changeofaddresscertificate")
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalChangeOfAddress(userid,Status.Approved)
    .then((response: any) => {
...
// .GetApplicationByDocumentId("7",userid)
 .GetChangeOfAddressApplicationById(this.pwalletid2,userid2)
 .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/TreatedChangeOfAddress"))  {
