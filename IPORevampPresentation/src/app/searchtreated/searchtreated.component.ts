...
@Component({
  selector: 'app-searchtreated',
  templateUrl: './searchtreated.component.html',
  styleUrls: ['./searchtreated.component.css']
})
export class SearchtreatedComponent implements OnInit {
