...
@Component({
  selector: 'app-receive-appeal',
  templateUrl: './receive-appeal.component.html',
  styleUrls: ['./receive-appeal.component.css']
})
export class ReceiveAppealComponent implements OnInit {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/ReceiveAppeal"))  {
