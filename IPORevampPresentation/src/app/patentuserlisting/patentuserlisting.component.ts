...
@Component({
  selector: 'app-patentuserlisting',
  templateUrl: './patentuserlisting.component.html',
  styleUrls: ['./patentuserlisting.component.css']
})
export class PatentuserlistingComponent implements OnInit {
