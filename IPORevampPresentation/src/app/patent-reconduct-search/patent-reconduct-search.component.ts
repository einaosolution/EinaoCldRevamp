...
@Component({
  selector: 'app-patent-reconduct-search',
  templateUrl: './patent-reconduct-search.component.html',
  styleUrls: ['./patent-reconduct-search.component.css']
})
export class PatentReconductSearchComponent implements OnInit {
...
onChange( deviceValue) {
  ...
  getallApplication2() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetPatentExaminerReconductSearch(userid)
    .then((response: any) => {
