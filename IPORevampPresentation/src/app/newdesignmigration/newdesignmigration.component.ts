...
@Component({
  selector: 'app-newdesignmigration',
  templateUrl: './newdesignmigration.component.html',
  styleUrls: ['./newdesignmigration.component.css']
})
export class NewdesignmigrationComponent implements OnInit {
...
this.registerapi.RemoveCoApplicant(this.vid)
  ...
  this.ReintializeData();
      ...
      onChange3(deviceValue) {
        ...
        this.registerapi
     .DesigncountByRegistration(this.userform.value.designregistration)
     .then((response: any) => {
     ...
     if (parseInt(response) > 0) {
        (<FormControl> this.userform.controls['designregistration']).setValue("");
...
console.log(this.row101)
  ...
  formData.append("registration_number",this.userform.value.designregistration);
...
onChange($event) {
  ...
  //  this.dtTrigger.next();
    ...
    this.userform = this.formBuilder.group({
      ...
      designregistration:  [null,Validators.required ],
