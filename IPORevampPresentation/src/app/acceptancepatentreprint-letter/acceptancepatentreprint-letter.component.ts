...
@Component({
  selector: 'app-acceptancepatentreprint-letter',
  templateUrl: './acceptancepatentreprint-letter.component.html',
  styleUrls: ['./acceptancepatentreprint-letter.component.css']
})
export class AcceptancepatentreprintLetterComponent implements OnInit {
