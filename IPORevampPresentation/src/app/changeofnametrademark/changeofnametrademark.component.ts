...
@Component({
  selector: 'app-changeofnametrademark',
  templateUrl: './changeofnametrademark.component.html',
  styleUrls: ['./changeofnametrademark.component.css']
})
export class ChangeofnametrademarkComponent implements OnInit {
...
if (this.regnumber == "") {
  ...
  this.router.navigateByUrl('/Dashboard/Noticeofchangeofname');
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/ChangeOfName"))  {
