...
@Component({
  selector: 'app-patent-search-kiv',
  templateUrl: './patent-search-kiv.component.html',
  styleUrls: ['./patent-search-kiv.component.css']
})
export class PatentSearchKivComponent implements OnInit {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/PatentSearchKiv"))  {
