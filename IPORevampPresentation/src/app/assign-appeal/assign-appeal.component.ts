...
@Component({
  selector: 'app-assign-appeal',
  templateUrl: './assign-appeal.component.html',
  styleUrls: ['./assign-appeal.component.css']
})
export class AssignAppealComponent implements OnInit {
...
onSubmit2() {
  ...
  if (this.appcomment =="") {
   ...
   formData.append("fromstatus","Registra");
   formData.append("tostatus","Appeal");
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/AssignAppeal"))  {
    ...
    this.registerapi.setPage("RegistraTrademark")

    this.registerapi.VChangeEvent("RegistraTrademark");
