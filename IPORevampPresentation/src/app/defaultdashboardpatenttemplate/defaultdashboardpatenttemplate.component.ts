...
@Component({
  selector: 'app-defaultdashboardpatenttemplate',
  templateUrl: './defaultdashboardpatenttemplate.component.html',
  styleUrls: ['./defaultdashboardpatenttemplate.component.css']
})
export class DefaultdashboardpatenttemplateComponent implements OnInit {
...
public barChartLabels: Label[] = ['Search Officer', 'Examiner Officer', 'Publication Officer', 'Certificate Officer ', 'Appeal Officer'];
  ...
  ngAfterViewInit() {
    ...
    if (this.loginrole  ==Role.PatentSearch) {
 ...
 this.patentsearch()
    ...
    if (this.loginrole  ==Role.PatentExaminer) {
      ...
      this.patentexaminer()
         ...
         if (this.loginrole  ==Role.PatentCertificateOfficer) {

          this.patentCertificate()


             }


             if (this.loginrole  ==Role.AppealOfficerTrademark) {
              ...
              this.AppealUnit()
                 ...
                 if (this.loginrole  ==Role.AppealOfficerPatent) {
                  ...
                  this.AppealUnit()
                     ...
                     if (this.loginrole  ==Role.AppealOfficerDesign) {
...
NumberInUnit:response.result.patentExaminerFreshcount

}
this.newapplication =response.result.patentExaminerFreshcount
this.chartdata3.push(data)
...
data =  {
  ...
  NumberInUnit:response.result.patentExaminerTreatedcount

  }
  this.treatedapplication =response.result.patentExaminerTreatedcount
  this.chartdata3.push(data)
...
let totalsearchCount2 = parseInt(response.result.patentExaminerTreatedcount) + parseInt( response.result.researchApplicationcount)  + parseInt( response.result.patentExaminerFreshcount)
data =  {
  officer:"Total Search" ,
...
patentCertificate() {
 // this.ShowLabel3 = false;
  ...
  NumberInUnit:response.result.patentPaidCertificatecount

  }
  this.newapplication =response.result.patentPaidCertificatecount
  this.chartdata3.push(data)
  ...
  data =  {
    ...
    NumberInUnit:response.result.patentIssuedCertificatecount

    }
    this.treatedapplication =response.result.patentIssuedCertificatecount
    this.chartdata3.push(data)
  ...
  let totalsearchCount2 = parseInt(response.result.patentPaidCertificatecount) + parseInt( response.result.patentIssuedCertificatecount)
  data =  {
  ...
  AppealUnit() {
    // this.ShowLabel3 = false;
     this.Label1 = "Trademark Appeal";
     this.Label2 = "Patent Appeal";
     this.Label3 = "";
     this.Label4 = "Design Appeal";
     this.ShowLabel3 = false;
     ...
     this.newapplication =response.result.trademarkAppealcount




       this.treatedapplication =response.result.patentAppealcount
     ...
     this.totalsearchCount = response.result.designAppealcount
