...
@Component({
  selector: 'app-merger-trademark',
  templateUrl: './merger-trademark.component.html',
  styleUrls: ['./merger-trademark.component.css']
})
export class MergerTrademarkComponent implements OnInit {
...
let userid = localStorage.getItem('UserId');
  ...
  this.router.navigateByUrl('/Dashboard/Noticeofmerger');
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/RenewTrademark"))  {
