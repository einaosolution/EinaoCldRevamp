...
@Component({
  selector: 'app-gen-recordal-renew-patent-component',
  templateUrl: './gen-recordal-renew-patent-component.component.html',
  styleUrls: ['./gen-recordal-renew-patent-component.component.css']
})
export class GenRecordalRenewPatentComponentComponent implements OnInit {
 ...
 // $("#createmodel").modal('hide');
  ...
  this.busy =   this.registerapi.UpdateRenewalPatentFormStatus(this.pwalletid2,userid)
.then((response: any) => {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalRenewalPatentCertificate(userid)
    .then((response: any) => {
 ...
 this.pwalletid2= kk.renewalid
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/GenRecordalRenewPatent"))  {
    ...
    this.registerapi.setPage("PatentRecordal")

    this.registerapi.VChangeEvent("PatentRecordal");
