...
@Component({
  selector: 'app-usercounter-opposition',
  templateUrl: './usercounter-opposition.component.html',
  styleUrls: ['./usercounter-opposition.component.css']
})
export class UsercounterOppositionComponent implements OnInit {
...
let userid = localStorage.getItem('UserId');
  ...
  this.router.navigateByUrl('/Dashboard/NoticeOfCounterOpposition');
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetOppositionByUserid(userid ,userid)
    .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/UsercounterOpposition"))  {
