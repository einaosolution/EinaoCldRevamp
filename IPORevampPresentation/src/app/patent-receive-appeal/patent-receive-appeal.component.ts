...
@Component({
  selector: 'app-patent-receive-appeal',
  templateUrl: './patent-receive-appeal.component.html',
  styleUrls: ['./patent-receive-appeal.component.css']
})
export class PatentReceiveAppealComponent implements OnInit {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Patent/DelegateAppeal"))  {
