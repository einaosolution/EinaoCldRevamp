...
@Component({
  selector: 'app-defaultdashboardadmintemplate',
  templateUrl: './defaultdashboardadmintemplate.component.html',
  styleUrls: ['./defaultdashboardadmintemplate.component.css']
})
export class DefaultdashboardadmintemplateComponent implements OnInit {
    ...
    this.loginrole = localStorage.getItem('Roleid');
         ...
         if (this.loginrole  ==Role.Admin) {
          ...
          this.patentCertificate()
             ...
             if (this.loginrole  ==Role.SuperAdmin) {
...
patentCertificate() {
 // this.ShowLabel3 = false;
  ...
  this.totalsearchCount = response.result.usercount
