...
@Component({
  selector: 'app-user-opposition',
  templateUrl: './user-opposition.component.html',
  styleUrls: ['./user-opposition.component.css']
})
export class UserOppositionComponent implements OnInit {
...
.then((response: any) => {
  ...
  this.dtOptions = {
   ...
   this.busy =   this.registerapi
    .GetPublicationByRegistrationId(userid ,"")
    .then((response: any) => {
