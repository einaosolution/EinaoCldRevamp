...
@Component({
  selector: 'app-examiner-patent-fresh',
  templateUrl: './examiner-patent-fresh.component.html',
  styleUrls: ['./examiner-patent-fresh.component.css']
})
export class ExaminerPatentFreshComponent implements OnInit {
