...
@Component({
  selector: 'app-gen-recordal-merger-and-assignment',
  templateUrl: './gen-recordal-merger-and-assignment.component.html',
  styleUrls: ['./gen-recordal-merger-and-assignment.component.css']
})
export class GenRecordalMergerAndAssignmentComponent implements OnInit {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalMerger(userid,Status.Paid)
    .then((response: any) => {
