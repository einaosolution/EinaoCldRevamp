...
@Component({
  selector: 'app-defaultdashboard5',
  templateUrl: './defaultdashboard5.component.html',
  styleUrls: ['./defaultdashboard5.component.css']
})
export class Defaultdashboard5Component implements OnInit {
