...
@Component({
  selector: 'app-design-kiv-search',
  templateUrl: './design-kiv-search.component.html',
  styleUrls: ['./design-kiv-search.component.css']
})
export class DesignKivSearchComponent implements OnInit {
...
this. getallApplication2()
  ...
  getallApplication2() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetDesignKivSearchApplication(userid)
    .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Design/DesignKivSearch"))  {
