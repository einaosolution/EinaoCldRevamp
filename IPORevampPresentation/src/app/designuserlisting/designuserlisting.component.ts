...
@Component({
  selector: 'app-designuserlisting',
  templateUrl: './designuserlisting.component.html',
  styleUrls: ['./designuserlisting.component.css']
})
export class DesignuserlistingComponent implements OnInit {
