...
@Component({
  selector: 'app-refusal-patent-reprint',
  templateUrl: './refusal-patent-reprint.component.html',
  styleUrls: ['./refusal-patent-reprint.component.css']
})
export class RefusalPatentReprintComponent implements OnInit {
  row2:any;
  row3:any;
  elementType = 'url';
  comment :string =""
...
this.busy =   this.registerapi
.GetPatentRefusalComment(userid,pwallet)
.then((response: any) => {
