...
@Component({
  selector: 'app-publication-detail2',
  templateUrl: './publication-detail2.component.html',
  styleUrls: ['./publication-detail2.component.css']
})
export class PublicationDetail2Component implements OnInit {
...
doc.save ('Visiometria_'+this.id+ '_'+date.getTime()+'.pdf')
  ...
  if (firstParam) {
   ...
   .GetDesignPublicationById(userid ,firstParam)
   .then((response: any) => {

     console.log("Batch Design Response ")
