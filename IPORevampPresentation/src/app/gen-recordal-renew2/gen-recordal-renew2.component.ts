...
@Component({
  selector: 'app-gen-recordal-renew2',
  templateUrl: './gen-recordal-renew2.component.html',
  styleUrls: ['./gen-recordal-renew2.component.css']
})
export class GenRecordalRenew2Component implements OnInit {
...
showcountry2() {
  ...
  getallApplication() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetRecordalRenewalCertificate2(userid)
    .then((response: any) => {
...
this.row7 = response.content
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/TreatedRenewal"))  {
