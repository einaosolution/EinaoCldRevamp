...
@Component({
  selector: 'app-search-kiv',
  templateUrl: './search-kiv.component.html',
  styleUrls: ['./search-kiv.component.css']
})
export class SearchKivComponent implements OnInit {
