...
@Component({
  selector: 'app-user-kiv',
  templateUrl: './user-kiv.component.html',
  styleUrls: ['./user-kiv.component.css']
})
export class UserKivComponent implements OnInit {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/UserKiv"))  {
