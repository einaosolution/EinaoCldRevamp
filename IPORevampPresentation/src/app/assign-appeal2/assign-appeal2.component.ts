...
@Component({
  selector: 'app-assign-appeal2',
  templateUrl: './assign-appeal2.component.html',
  styleUrls: ['./assign-appeal2.component.css']
})
export class AssignAppeal2Component implements OnInit {
...
onSubmit2() {
  ...
  if (this.appcomment =="") {
   ...
   formData.append("fromstatus","Appeal");
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/AssignAppeal2"))  {
    ...
    this.registerapi.VChangeEvent("TrademarkAppeal");
