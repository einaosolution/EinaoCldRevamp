...
@Component({
  selector: 'app-refuse-application-reprint',
  templateUrl: './refuse-application-reprint.component.html',
  styleUrls: ['./refuse-application-reprint.component.css']
})
export class RefuseApplicationReprintComponent implements OnInit {
