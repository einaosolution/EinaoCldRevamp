...
@Component({
  selector: 'app-patent-registra-certificate',
  templateUrl: './patent-registra-certificate.component.html',
  styleUrls: ['./patent-registra-certificate.component.css']
})
export class PatentRegistraCertificateComponent implements OnInit {
