...
@Component({
  selector: 'app-noticeofchangeofname',
  templateUrl: './noticeofchangeofname.component.html',
  styleUrls: ['./noticeofchangeofname.component.css']
})
export class NoticeofchangeofnameComponent implements OnInit {
...
if (f) {
  ...
  formData.append("oldName",this.account.name);
  formData.append("oldsurname",this.account.name2);
  formData.append("newname",this.account.firstname);
  formData.append("newsurname",this.account.surname);
 ...
 // formData.append("nice_class_description",this.account.trademarkdesc);
  ...
  .then((response: any) => {
   ...
   // alert(this.NoticeAppID)
    ...
    this.busy =   this.registerapi
.GetChangeOfNameApplicationById(this.NoticeAppID,userid)
.then((response: any) => {

  console.log("change of name response")
  console.log(response.content)
...
//$(this).steps("next");
  ...
  localStorage.setItem('PaymentType',"changeofname");
  ...
  onSubmit3() {
    ...
    this.row = []
    //this.row.push(17)
    this.row.push(parseInt(Fee2.CHANGESINREGISTEREDPARTICULARSNAMESandADDRESSESETC))
    var userid = localStorage.getItem('UserId');
  ...
  var vdesc =  localStorage.getItem('description');
    ...
    if (firstParam) {
      ...
      .then((response: any) => {
       ...
       this.account.name = response.content.firstName
       this.account.name2 = response.content.lastName
  ...
  this.busy =   this.registerapi
.GetFeeListById(Fee2.CHANGESINREGISTEREDPARTICULARSNAMESandADDRESSESETC ,userid)
.then((response: any) => {
