...
@Component({
  selector: 'app-acknowledgement-patent',
  templateUrl: './acknowledgement-patent.component.html',
  styleUrls: ['./acknowledgement-patent.component.css']
})
export class AcknowledgementPatentComponent implements OnInit {
