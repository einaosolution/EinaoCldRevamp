...
@Component({
  selector: 'app-acknowledgement-design',
  templateUrl: './acknowledgement-design.component.html',
  styleUrls: ['./acknowledgement-design.component.css']
})
export class AcknowledgementDesignComponent implements OnInit {
