...
@Component({
  selector: 'app-design-registra-appeal',
  templateUrl: './design-registra-appeal.component.html',
  styleUrls: ['./design-registra-appeal.component.css']
})
export class DesignRegistraAppealComponent implements OnInit {
...
onChange( deviceValue) {
  ...
  getallApplication2() {
    ...
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetDesignAppealApplication(userid)
    .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Design/DesignRegistraAppeal"))  {
