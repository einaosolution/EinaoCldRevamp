...
@Component({
  selector: 'app-acceptancedesign-reprintletter',
  templateUrl: './acceptancedesign-reprintletter.component.html',
  styleUrls: ['./acceptancedesign-reprintletter.component.css']
})
export class AcceptancedesignReprintletterComponent implements OnInit {
