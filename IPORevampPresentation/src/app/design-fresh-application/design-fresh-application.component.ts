...
@Component({
  selector: 'app-design-fresh-application',
  templateUrl: './design-fresh-application.component.html',
  styleUrls: ['./design-fresh-application.component.css']
})
export class DesignFreshApplicationComponent implements OnInit {
...
this. getallApplication2()
  ...
  getallApplication2() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetDesignFreshapplication(userid)
    .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Design/FreshApplication"))  {
