...
@Component({
  selector: 'app-refusaldesignreprintletter',
  templateUrl: './refusaldesignreprintletter.component.html',
  styleUrls: ['./refusaldesignreprintletter.component.css']
})
export class RefusaldesignreprintletterComponent implements OnInit {
