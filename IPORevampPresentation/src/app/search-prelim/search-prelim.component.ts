...
@Component({
  selector: 'app-search-prelim',
  templateUrl: './search-prelim.component.html',
  styleUrls: ['./search-prelim.component.css']
})
export class SearchPrelimComponent implements OnInit {
