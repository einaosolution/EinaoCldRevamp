...
@Component({
  selector: 'app-pay-design-certificate',
  templateUrl: './pay-design-certificate.component.html',
  styleUrls: ['./pay-design-certificate.component.css']
})
export class PayDesignCertificateComponent implements OnInit {
...
// console.log("this.rows")
 // console.log(vcount)
  ...
  getallApplication2() {
    var userid = localStorage.getItem('UserId');
    this.busy =   this.registerapi
    .GetDesignCertificatePayment(userid)
    .then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Design/PayDesignCertificate"))  {
