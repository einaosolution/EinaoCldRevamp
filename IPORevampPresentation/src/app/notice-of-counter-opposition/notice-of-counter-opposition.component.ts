...
@Component({
  selector: 'app-notice-of-counter-opposition',
  templateUrl: './notice-of-counter-opposition.component.html',
  styleUrls: ['./notice-of-counter-opposition.component.css']
})
export class NoticeOfCounterOppositionComponent implements OnInit {
