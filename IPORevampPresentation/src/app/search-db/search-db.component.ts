...
export class SearchDbComponent implements OnInit {
  ...
  appcomment2="" ;
  appcomment4 ="" ;
  varray4 = [{ YearName: 'Exact Search', YearCode: 'Exact Search' }, { YearName: 'Search For Meaning', YearCode: 'Search For Meaning' } ]
...
if (this.searchtype =="Exact Search") {


  this.busy =   this.registerapi
  .GetExactSearch(this.regnumber)
  .then((response: any) => {
...
if (this.searchtype =="Search For Meaning") {



  this.busy =   this.registerapi
  .GetMeaningSearch(this.regnumber)
  .then((response: any) => {
...
.then((response: any) => {
  ...
  ngOnInit() {
    ...
    if (this.registerapi.checkAccess("#/Dashboard/SearchDb"))  {
